...
The programs of this topic consist in a main program (Heart_of_the_program) that applies the principles of dynamic programming to specific scenarios in order to obtain a "decision matrix"
